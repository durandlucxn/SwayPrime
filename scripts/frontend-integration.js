 ...
 * This file demonstrates how to integrate Swayprime with a web frontend
 */

// For React/Vue/Angular applications
export class SwayprimeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SwayprimeClient(provider, contractAddress);
